...
LEDGER_RESULT=1
LEDGER_NVM_DELAY=1
LEDGER_PASS_THROUGH=0
LEDGER_MOVNTI=1
LEDGER_ANON_MEM_HANDLE=1
LEDGER_BG_CLOSING=0
# END LEDGER VARS
...
CFLAGS = -DPRINT_DEBUG_FILE=$(LEDGER_DEBUG) -DPRINT_RESULT_FILE=$(LEDGER_RESULT) -DNVM_DELAY=$(LEDGER_NVM_DELAY) -DPASS_THROUGH_CALLS=$(LEDGER_PASS_THROUGH) -DNON_TEMPORAL_WRITES=$(LEDGER_MOVNTI) -DANON_MEM_HANDLE=$(LEDGER_ANON_MEM_HANDLE) -DBG_CLOSING=$(LEDGER_BG_CLOSING) -DSHOW_DEBUG=$(LIBNVP_DEBUG) -DSPIN_ON_ERROR=$(LIBNVP_SPIN_ON_ERROR) -Wall -Wundef -pthread -fPIC -Wno-unused-variable  -g $(COPTIMIZATIONS) -D$(SYSTEM_TYPE) -DUSE_PTHREAD_LOCK=$(USE_PTHREAD_LOCK) -DUSE_SCHED_GETCPU=$(USE_SCHED_GETCPU) -DINTEGRITY_CHECK=$(INTEGRITY_CHECK) -DMEASURE_TIMING=$(MEASURE_TIMING) -DUSE_SINGLE_LOCK=$(USE_SINGLE_LOCK) -DENABLE_FSYNC_TO_BS=$(ENABLE_FSYNC_TO_BS) -DENABLE_FSYNC_TO_CACHE=$(ENABLE_FSYNC_TO_CACHE) -DENABLE_FALLOC=$(ENABLE_FALLOC) -DUSE_BTREE=$(USE_BTREE) -DUNMAP_ON_CLOSE=$(UNMAP_ON_CLOSE)
