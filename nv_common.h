...
#define TRACE_FP_CALLS 1

#ifdef TRACE_FP_CALLS				

#define ALLOPS_FINITEPARAMS_WPAREN (READ) (FREAD) (WRITE) (FWRITE) (FSEEK) (FTELL) (FTELLO) (CLOSE) (FCLOSE) (SEEK) (TRUNC) (DUP) (DUP2) (FORK) (READV) (WRITEV) (PIPE) OPS_FINITEPARAMS_64 (PREAD) (PWRITE) (FSYNC) (FDSYNC) (SOCKET) (ACCEPT) (UNLINK) (UNLINKAT)
//#define OPENOPS_WPAREN (OPEN) (FOPEN)
#define ALLOPS_WPAREN (OPEN) (OPENAT) (EXECVE) (EXECVP) (EXECV) (EXECL) (FOPEN) (FCNTL) (FOPEN64) (IOCTL) ALLOPS_FINITEPARAMS_WPAREN
...
//#define OPENOPS_WPAREN (OPEN)
#define ALLOPS_WPAREN (OPEN) (OPENAT) (EXECVE) (EXECVP) (EXECV) (EXECL) (FCNTL) (IOCTL) ALLOPS_FINITEPARAMS_WPAREN
#define SHM_WPAREN (SHM_COPY)
...
//(ACCEPT)
#define FILEOPS_WITHOUT_FD (FORK)
...
#define CHECK_RESOLVE_FILEOPS(NAME) do{					\
		if(UNLIKELY(NAME##fileops==NULL)) {			\
			...
			MSG("%s: resolving fileops\n", __func__);	\
			NAME##init();					\
			NAME##resolve_fileops("hub(posix,nvp(posix))");	\
		}							\
	} while(0)
/*
...
#define ALIAS_MKSTEMP mkstemp64
...
#define INTF_NVP_OPEN   const char* path, int oflag, unsigned short *inode_mode, ...
...
#define INTF_EXECL const char *path, const char *arg, ...
#define INTF_SHM_COPY void

#ifdef TRACE_FP_CALLS

#define INTF_NVP_FOPEN const char* __restrict path, const char* __restrict mode, unsigned short *inode_mode
...
//#define INTF_FDOPEN  int file, const char *__restrict mode
...
#define DECLARE_WITHOUT_ALIAS_FUNCS(FUNCT, prefix) \
	RETT_##FUNCT prefix##FUNCT(INTF_##FUNCT);
#define DECLARE_WITHOUT_ALIAS_OPEN_FUNCS(FUNCT, prefix) \
	RETT_##FUNCT prefix##FUNCT(INTF_NVP_##FUNCT);
#define DECLARE_WITHOUT_ALIAS_FUNCTS_IWRAP(r, data, elem) DECLARE_WITHOUT_ALIAS_FUNCS(elem, data)
#define DECLARE_WITHOUT_ALIAS_FUNCTS_OPEN_IWRAP(r, data, elem) DECLARE_WITHOUT_ALIAS_OPEN_FUNCS(elem, data)
